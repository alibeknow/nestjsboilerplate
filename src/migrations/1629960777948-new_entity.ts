...
export class newEntity1629960777948 implements MigrationInterface {
    name = 'newEntity1629960777948'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "documents_status_enum" AS ENUM('PENDING', 'DECLINE', 'SIGNED', 'APPROVED')`);
